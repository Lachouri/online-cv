    ...
    render() {
        return (
            <section id="projects" className="section-projects">
                ...
                <span className="projects-category6"><a target="_blank" href="http://ec2-3-249-249-226.eu-west-1.compute.amazonaws.com/KtneGame/"><i className="fas fa-bomb"></i></a> <br /><span className="title">Keep Talking and Nobody Explodes Remastered </span><br /> <p className="techno-desc">A school project was to make some modules of the game "Keep Talking and Nobody explodes".
